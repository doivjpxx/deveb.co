...
//   },[])
  ...
  return( 
    <main id="viewport" ref={el} data-scroll-container className="projects-page" >
      ...
      <Helmet>
        <title>Deveb All Projects</title>
        <meta name="description" content="View all our past projects in Branding, Design and Development." />
        <meta property="og:title" content="Deveb All Projects" />
        <meta property="og:description" content="View all our past projects in Branding, Design and Development." />
      </Helmet>
