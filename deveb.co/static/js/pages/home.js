...
import "../serv.scss";
import AwardsPreface from '../components/awardspre/awardspreface.js'
// import AwardsChain from '../components/awardspre/awardschain.js'
// import AwardsShowcase from '../components/awardspre/awardsshowcase'
// import HomeServ from '../components/homeServices.js'
...
// import HomePrices from '../components/pricetag.js';
  ...
  return( 
    ...
    <main id="viewport" ref={el} data-scroll-container >
      ...
      <Helmet>
        ...
        <meta property="og:title" content="Deveb • Creative Digital Agency" />
        <meta property="og:description" content="A creative agency with solid design and development expertise. We shape brands, design and build websites." />
      </Helmet>
      ...
      <Suspense fallback={ <Loading/> }>
        ...
        {/* Temporary Spacing for the deleted sections */}
        {
          !isMobile ? <div className="temporary-spacer" style={{ marginBottom: '4rem' }}></div> : ''
        }
        
        
        {/* <AwardsChain/>
        <AwardsShowcase isMobile/>
        <HomeServ/>
        <HomePrices/> */}
