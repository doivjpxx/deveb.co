...
const AboutPage = () => {
  ...
  return (
    <main ref={el} id="viewport" data-scroll-container className='aboutpage'>
      ...
      <Helmet>
        <title>Deveb About | Creative Digital Agency</title>
        ...
        <meta property="og:title" content="Deveb About | Creative Digital Agency" />
        <meta property="og:description" content="We at deveb strive to fulfill your digital dreams and present your product in the most approachable way possible." />
      </Helmet>
