...
export default function Thanks({ showToggle, isMobile }) {
    ...
    <div className="thanks-container" onClick={ () => showToggle()}>
      {
        isMobile && 
          <div className="checkcontain">
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="122.877px" height="101.052px" viewBox="0 0 122.877 101.052" enable-background="new 0 0 122.877 101.052" >
              <g>
