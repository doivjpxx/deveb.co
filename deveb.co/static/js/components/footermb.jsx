      ...
      <div className="trig">
        ...
        <div className="footer-foot">
          ...
          Get a quote
            ...
            <div>
            <div>
              <a href="https://www.linkedin.com/company/deveb-co/" target="_blank"> <img className="linkedin" src={linkedin} /></a>
              <a href="https://github.com/Deveb-co" target="_blank"><img className="git" src={git} /></a>
              <a href="https://dribbble.com/deveb-co" target="_blank"><img className="drib" src={drib} /></a>
